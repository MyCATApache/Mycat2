        ...
        try {
            ...
            if (client.checkExists().forPath(taskBase) != null) {
                ...
                for (String child : childTaskList) {
                    ...
                    TaskNode taskNode = new Gson().fromJson(str, TaskNode.class);
            ...
            transactionFinal = client.inTransaction().setData().forPath(taskPath, JSONUtils.toJSONString(taskNode).getBytes()).and();
            ...
            for (Map.Entry<String, List<MigrateTask>> entry : dataHostMigrateMap.entrySet()) {
                ...
                transactionFinal = transactionFinal.create().forPath(path, JSONUtils.toJSONString(value).getBytes()).and();
            }
