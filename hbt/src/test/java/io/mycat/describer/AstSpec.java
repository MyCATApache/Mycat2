...
//        Assert.assertEquals("DistinctSchema(schema=ValuesSchema(table=[], fieldNames=[FieldType(id=1, type=int)]))", select.toString());
//    }
//
//    @Test
...
//        Assert.assertEquals("ProjectSchema(schema=ValuesSchema(table=[], fieldNames=[FieldType(id=1, type=int), FieldType(id=2, type=string)]), columnNames=[2, 1], fieldSchemaList=[FieldType(id=1, type=int), FieldType(id=2, type=string)])", select.toString());
//    }
//
//    @Test
...
//        Assert.assertEquals("ProjectSchema(schema=ValuesSchema(table=[], fieldNames=[FieldType(id=id, type=int), FieldType(id=id2, type=string)]), columnNames=[id3, id4], fieldSchemaList=[FieldType(id=id, type=int), FieldType(id=id2, type=string)])", select.toString());
//    }
//
//    @Test
