...
public class MycatOutputVisitor extends SQLASTOutputVisitor implements MySqlASTVisitor {
    ...
    public MycatOutputVisitor(Appendable appender, boolean parameterized) {
    ...
    public boolean visit(MySqlTableIndex x) {
        ...
        SQLIndexDefinition indexDefinition = x.getIndexDefinition();
         SQLExpr dbPartitions = null;
        try {
            Method declaredMethod = indexDefinition.getClass().getDeclaredMethod("getDbPartitions");
            dbPartitions = (SQLExpr)declaredMethod.invoke(indexDefinition);
        } catch (Throwable e) {
            e.printStackTrace();
        }
