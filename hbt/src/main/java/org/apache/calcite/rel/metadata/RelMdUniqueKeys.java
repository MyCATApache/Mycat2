...
public class RelMdUniqueKeys
  ...
  public @Nullable Set<ImmutableBitSet> getUniqueKeys(MycatView rel, RelMetadataQuery mq,
                                                      boolean ignoreNulls) {
    RelNode relNode = rel.getRelNode();
    return mq.getUniqueKeys(relNode, ignoreNulls);
  }
