...
public class RelJsonReader {
  ...
  private void readRel(final Map<String, Object> jsonRel) {
    ...
    RelInput input = new RelInput() {
      ...
      @Override
      public List<Window.Group> getWindowGroupList() {
        return toWindowGroupList(this,(List)jsonRel.get("groups"));
      }
  ...
  private List<Window.Group> toWindowGroupList(RelInput relInput, List<Object> windowGroupList) {
      if(windowGroupList == null){
          return Collections.emptyList();
      }
      ImmutableList.Builder<Window.Group> builder = ImmutableList.builder();
      for (Object e : windowGroupList) {
          Map<String,Object> group = (Map)e;
          builder.add(relJson.toWindowGroup(relInput,group));
      }
      return builder.build();
  }
