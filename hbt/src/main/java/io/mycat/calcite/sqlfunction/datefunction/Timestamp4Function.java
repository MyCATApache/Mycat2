...
public class Timestamp4Function extends MycatDateFunction {
    public static ScalarFunction scalarFunction = ScalarFunctionImpl.create(Timestamp4Function.class,
            "timestamp");
    public static Timestamp4Function INSTANCE = new Timestamp4Function();


    public Timestamp4Function() {
    ...
    //DateTimeUtils
    //SqlLiteral
    public static LocalDateTime timestamp(LocalDate date,Duration time) {
        if (date == null) {
            return null;
        }
        return date.atStartOfDay().plus(time);
    }
