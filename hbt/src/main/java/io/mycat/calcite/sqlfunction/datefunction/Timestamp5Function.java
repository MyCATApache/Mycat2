...
public class Timestamp5Function extends MycatDateFunction {
    public static ScalarFunction scalarFunction = ScalarFunctionImpl.create(Timestamp5Function.class,
            "timestamp");
    public static Timestamp5Function INSTANCE = new Timestamp5Function();


    public Timestamp5Function() {
    ...
    //DateTimeUtils
    //SqlLiteral
    public static LocalDateTime timestamp(LocalDate date,String time) {
        if (date == null) {
            return null;
        }
        return date.atStartOfDay().plus(MycatBuiltInMethodImpl.timeStringToTimeDuration(time));
    }
