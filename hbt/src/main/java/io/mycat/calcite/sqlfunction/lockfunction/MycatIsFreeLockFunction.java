...
public class MycatIsFreeLockFunction extends MycatSqlDefinedFunction {
    public final static MycatIsFreeLockFunction INSTANCE = new MycatIsFreeLockFunction();
