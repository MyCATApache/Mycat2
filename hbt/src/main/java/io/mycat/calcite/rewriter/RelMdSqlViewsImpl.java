...
public class RelMdSqlViewsImpl implements RelMdSqlViews {

    final static NextConvertor nextConvertor = new NextConvertor();
    final static List<RelOptRule> RULES;

    public static final RelMdSqlViews INSTANCE = new RelMdSqlViewsImpl();
...
//                builder.add(new RBORule(base,up));
    ...
    public  boolean onJoin(RelNode relNode) {
        Objects.requireNonNull(relNode);
    ...
    public  boolean onProject(RelNode relNode) {
        Objects.requireNonNull(relNode);
    ...
    public  boolean onAggregate(RelNode relNode) {
        Objects.requireNonNull(relNode);
    ...
    public  boolean onRelNode(RelNode base, RelNode relNode) {
        Objects.requireNonNull(relNode);
