 ...
 */
public class MycatJoinPushThroughJoinRule
        extends RelRule<MycatJoinPushThroughJoinRule.Config> {
    /** Instance of the rule that works on logical joins only, and pushes to the
     * right. */
    public static final MycatJoinPushThroughJoinRule RIGHT = Config.RIGHT.toRule();

    /** Instance of the rule that works on logical joins only, and pushes to the
     * left. */
    public static final MycatJoinPushThroughJoinRule LEFT = Config.LEFT.toRule();

    /** Creates a JoinPushThroughJoinRule. */
    protected MycatJoinPushThroughJoinRule(Config config) {
        super(config);
    }

    @Deprecated // to be removed before 2.0
    public MycatJoinPushThroughJoinRule(String description, boolean right,
...
//        }
    ...
    public interface Config extends RelRule.Config {
        ...
        @Override default MycatJoinPushThroughJoinRule toRule() {
            return new MycatJoinPushThroughJoinRule(this);
        }
