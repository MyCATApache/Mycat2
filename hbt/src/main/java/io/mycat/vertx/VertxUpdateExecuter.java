    ...
    public static Collection<VertxExecuter.EachSQL> explainUpdate(DrdsSqlWithParams drdsSqlWithParams, MycatDataContext context) {
        ...
        switch (table.getType()) {
            case SHARDING: {
                ...
                List<VertxExecuter.EachSQL> res = new ArrayList<>(partitions.size());
            ...
            case GLOBAL: {
                ...
                List<VertxExecuter.EachSQL> res = new ArrayList<>(globalTable.getGlobalDataNode().size());
            ...
            case NORMAL: {
                ...
                List<VertxExecuter.EachSQL> res = new ArrayList<>(1);
