 ...
 */
package io.mycat.mpp.parser;

import com.alibaba.fastsql.sql.SQLUtils;
import com.alibaba.fastsql.sql.ast.*;
import com.alibaba.fastsql.sql.ast.expr.*;
import com.alibaba.fastsql.sql.ast.statement.*;
import com.alibaba.fastsql.sql.dialect.db2.ast.DB2Object;
import com.alibaba.fastsql.sql.dialect.db2.ast.stmt.DB2SelectQueryBlock;
import com.alibaba.fastsql.sql.dialect.db2.visitor.DB2ASTVisitorAdapter;
...
import com.alibaba.fastsql.sql.dialect.hive.visitor.HiveASTVisitorAdapter;
import com.alibaba.fastsql.sql.dialect.mysql.ast.MysqlForeignKey;
import com.alibaba.fastsql.sql.dialect.mysql.ast.clause.MySqlCursorDeclareStatement;
import com.alibaba.fastsql.sql.dialect.mysql.ast.clause.MySqlDeclareStatement;
import com.alibaba.fastsql.sql.dialect.mysql.ast.clause.MySqlRepeatStatement;
...
import com.alibaba.fastsql.sql.dialect.odps.visitor.OdpsASTVisitorAdapter;
import com.alibaba.fastsql.sql.dialect.oracle.ast.stmt.*;
import com.alibaba.fastsql.sql.dialect.oracle.visitor.OracleASTVisitorAdapter;
import com.alibaba.fastsql.sql.dialect.postgresql.ast.stmt.*;
import com.alibaba.fastsql.sql.dialect.postgresql.visitor.PGASTVisitorAdapter;
import com.alibaba.fastsql.sql.dialect.sqlserver.ast.SQLServerSelectQueryBlock;
import com.alibaba.fastsql.sql.dialect.sqlserver.ast.stmt.SQLServerInsertStatement;
import com.alibaba.fastsql.sql.dialect.sqlserver.ast.stmt.SQLServerUpdateStatement;
import com.alibaba.fastsql.sql.dialect.sqlserver.visitor.SQLServerASTVisitorAdapter;
import com.alibaba.fastsql.sql.repository.SchemaObject;
import com.alibaba.fastsql.sql.repository.SchemaRepository;
import com.alibaba.fastsql.sql.visitor.SQLASTVisitorAdapter;
import com.alibaba.fastsql.util.FnvHash;
import com.alibaba.fastsql.util.PGUtils;
                ...
                if (resolvedTableSource instanceof SQLWithSubqueryClause.Entry) {
                    ...
                    if (firstQueryBlock != null) {
                        for (SQLSelectItem item : firstQueryBlock.getSelectList()) {
                            SQLIdentifierExpr columnExpr = new SQLIdentifierExpr(item.computeAlias());
