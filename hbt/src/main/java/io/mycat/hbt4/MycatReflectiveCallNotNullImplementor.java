 ...
 * created.
 */
public class MycatReflectiveCallNotNullImplementor implements MycatNotNullImplementor {
  protected final Method method;

  /**
   * Constructor of {@link MycatReflectiveCallNotNullImplementor}
   * @param method method that is used to implement the call
   */
  public MycatReflectiveCallNotNullImplementor(Method method) {
    this.method = method;
  }

  public Expression implement(MycatRexToLixTranslator translator,
