                            ...
                            switch (command.getType()) {
                                case SCHEMA: {
                                    ...
                                    item1.setOnAction(event1 -> {
                                        ...
                                        if (doAction) {
                                            infoProvider.deleteLogicalSchema(command.getSchema());
                                            controller.flashRoot(infoProvider);
                                        }
                                    });
                                    contextMenu.getItems().add(item1);
                                    break;
                                ...
                                case SHARDING_TABLE:{
                                    ...
                                    item1.setOnAction(event1 -> {
                                        ...
                                        if (doAction) {
                                            infoProvider.deleteDatasource(command.getDatasource());
                                            controller.flashDataSource(infoProvider);
                                        }
                                    });
