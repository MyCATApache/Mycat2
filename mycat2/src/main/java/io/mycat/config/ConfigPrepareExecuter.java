...
//        replicaSelector = createReplicaSelector(mycatRouterConfig, loadBalanceManager, datasourceConfigMap);
...
//
//    @NotNull
//    public static ReplicaSelectorRuntime createReplicaSelector(MycatRouterConfig mycatRouterConfig, LoadBalanceManager loadBalanceManager, Map<String, DatasourceConfig> datasourceConfigMap) {
//        return new ReplicaSelectorRuntime(mycatRouterConfig.getClusters(), datasourceConfigMap, loadBalanceManager,
//                name -> {
//                    try {
