 ...
 * @author zongtanghu
 */
public class MycatPriorityElectionNode implements Lifecycle<MycatPriorityElectionNodeOptions> {

    private static final Logger              LOG       = LoggerFactory.getLogger(MycatPriorityElectionNode.class);

    private final List<MycatLeaderStateListener>  listeners = new CopyOnWriteArrayList<>();
    private RaftGroupService                 raftGroupService;
    private Node                             node;
    private MycatPriorityElectionOnlyStateMachine fsm;

    private boolean                          started;

    @Override
    public boolean init(final MycatPriorityElectionNodeOptions opts) {
        if (this.started) {
        ...
        this.fsm = new MycatPriorityElectionOnlyStateMachine(this.listeners);
    ...
    public MycatPriorityElectionOnlyStateMachine getFsm() {
        return this.fsm;
    }
