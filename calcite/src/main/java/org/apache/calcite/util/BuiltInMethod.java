...
//  TIME_TO_DOUBLE(SqlFunctions.class, "toInt", Time.class),
//  TIME_TO_DOUBLE_OPTIONAL(SqlFunctions.class, "toIntOptional", Time.class),
  TIMESTAMP_TO_DOUBLE(SqlFunctions.class, "toDouble", java.util.Date.class),
//  TIMESTAMP_TO_DOUBLE_OFFSET(SqlFunctions.class, "toDouble", java.util.Date.class,
//      TimeZone.class),
//  TIMESTAMP_TO_DOUBLE_OPTIONAL(SqlFunctions.class, "toDoubleOptional",
//      Timestamp.class),
//  TIMESTAMP_TO_DOUBLE_OPTIONAL_OFFSET(SqlFunctions.class, "toDoubleOptional",
