 ...
 *   </tr>
 *   <tr>
 *     <td>TIME</td> <td>{@link Time}</td>
 *                                   <td>int</td> <td>int</td>
 *   </tr>
 *   <tr>
 *     <td>DATE</td> <td>{@link Timestamp}</td>
 ...
 *   {@link java.sql.Date}, {@link Time}, {@link Timestamp},
 *   all sub-classes of {@link Date}. When they are passed to and
...
public class TypedValue {
  ...
  public static final TypedValue EXPLICIT_NULL =
      new TypedValue(Rep.OBJECT, null);
  ...
  public final Rep componentType;

  private TypedValue(Rep rep, Object value) {
    this(rep, null, value);
  }

  private TypedValue(Rep rep, Rep componentType, Object value) {
    this.type = rep;
  ...
  private boolean isSerial(Rep rep, Object value) {
    if (value == null) {
      return true;
    }
    switch (rep) {
  ...
  public static TypedValue ofJdbc(Object value, Calendar calendar) {
    ...
    final Rep rep = Rep.of(value.getClass());
   ...
   * representation. */
  private static Object serialToLocal(Rep rep, Object value) {
    assert value != null;
   ...
   */
  private static Object serialToJdbc(Rep type, Rep componentRep,
                                     Object value, Calendar calendar) {
    switch (type) {
    case BYTE_STRING:
      return ByteString.ofBase64((String) value).getBytes();
    case JAVA_UTIL_DATE:
      return new Date(adjust((Number) value, calendar));
    case JAVA_SQL_DATE:
      return new java.sql.Date(
          adjust(((Number) value).longValue() * DateTimeUtils.MILLIS_PER_DAY,
              calendar));
    case JAVA_SQL_TIME:
      return new Time(adjust((Number) value, calendar));
    case JAVA_SQL_TIMESTAMP:
      return new Timestamp(adjust((Number) value, calendar));
    case ARRAY:
      if (null == value) {
        return null;
      }
  ...
  private static Object jdbcToSerial(Rep rep, Object value,
                                     Calendar calendar) {
   ...
   * as JSON. */
  private static Object localToSerial(Rep rep, Object value) {
    switch (rep) {
    case BYTE_STRING:
  ...
  private static void writeToProtoWithType(Common.TypedValue.Builder builder, Object o,
    ...
    case JAVA_UTIL_DATE:
      ...
      if (o instanceof Timestamp) {
        sqlTimestampOrUtilDate = ((Timestamp) o).getTime();
      } else if (o instanceof Date) {
        sqlTimestampOrUtilDate = ((Date) o).getTime();
      } else {
  ...
  public static TypedValue fromProto(Common.TypedValue proto) {
    Rep rep = Rep.fromProto(proto.getType());
    Rep componentRep = Rep.fromProto(proto.getComponentType());
