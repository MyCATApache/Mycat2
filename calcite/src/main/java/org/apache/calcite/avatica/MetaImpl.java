 ...
 * It should also override metadata methods such as {@link #getCatalogs(ConnectionHandle)} and
...
public abstract class MetaImpl implements Meta {
  ...
  /** Uses a {@link CursorFactory} to convert
    ...
    try {
      ...
      final Signature signature =
          new Signature(columns, "", Collections.<AvaticaParameter>emptyList(),
              internalParameters, cursorFactory, StatementType.SELECT);
