 ...
 * {@link Meta.DatabaseProperty}. The name of the enum value will be
 * the name of the key in the {@link Properties} returned.
 *
 * <p>Some properties defined in {@link Meta.DatabaseProperty} do not
...
public interface AvaticaSpecificDatabaseMetaData extends DatabaseMetaData {
   ...
   * {@link Meta.DatabaseProperty} for a list of properties that will be
   * returned.
   *
