...
public class AvaticaDatabaseMetaData implements AvaticaSpecificDatabaseMetaData {
  ...
  public String getSQLKeywords() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<String>() {
          public String call() {
            return DatabaseProperty.GET_S_Q_L_KEYWORDS
  ...
  public String getNumericFunctions() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<String>() {
          public String call() {
            return DatabaseProperty.GET_NUMERIC_FUNCTIONS
                .getProp(connection.meta, connection.handle, String.class);
          }
        });
  }
  ...
  public String getStringFunctions() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<String>() {
          public String call() {
            return DatabaseProperty.GET_STRING_FUNCTIONS
                .getProp(connection.meta, connection.handle, String.class);
          }
        });
  }
  ...
  public String getSystemFunctions() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<String>() {
          public String call() {
            return DatabaseProperty.GET_SYSTEM_FUNCTIONS
                .getProp(connection.meta, connection.handle, String.class);
          }
        });
  }
  ...
  public String getTimeDateFunctions() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<String>() {
          public String call() {
            return DatabaseProperty.GET_TIME_DATE_FUNCTIONS
                .getProp(connection.meta, connection.handle, String.class);
          }
        });
  }
  ...
  public int getDefaultTransactionIsolation() throws SQLException {
    return connection.invokeWithRetries(
        new CallableWithoutException<Integer>() {
          public Integer call() {
            return DatabaseProperty.GET_DEFAULT_TRANSACTION_ISOLATION
