...
public abstract class AvaticaConnection implements Connection {
   ...
   * {@link Properties#getProperty(String)}. Derived projects will
  ...
  protected ResultSet createResultSet(MetaResultSet metaResultSet, QueryState state)
      throws SQLException {
  ...
  public static class Trojan {
    ...
    /** A means for anyone who has a trojan to call the protected method
     * {@link AvaticaStatement#getParameterValues()}.
     */
