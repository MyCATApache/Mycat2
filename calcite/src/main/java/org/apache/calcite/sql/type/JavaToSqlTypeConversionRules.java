...
public class JavaToSqlTypeConversionRules {
    ...
    static {
        ImmutableMap.Builder<Class<?>, SqlTypeName> builder = ImmutableMap.<Class<?>, SqlTypeName>builder();

        try {
            builder.put(Integer.class, SqlTypeName.INTEGER)
                    ...
                    .put(LocalDateTime.class, SqlTypeName.TIMESTAMP)
                    .put(LocalDate.class, SqlTypeName.DATE);
