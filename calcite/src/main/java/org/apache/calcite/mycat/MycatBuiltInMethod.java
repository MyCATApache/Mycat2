...
DECIMAL_TO_TINYINT(MycatBuiltInMethodImpl.class, "decimalToTinyint", BigDecimal.class),
    ...
    INTEGER_TO_SMALLINT(MycatBuiltInMethodImpl.class, "integerToTSmallint", Integer.class),
    ...
    INTEGER_TO_FLOAT(MycatBuiltInMethodImpl.class, "integerToFloat", Integer.class),
    ...
    INTEGER_TO_REAL(MycatBuiltInMethodImpl.class, "integerToReal", Integer.class),
    ...
    INTEGER_TO_DOUBLE(MycatBuiltInMethodImpl.class, "integerToDouble", Integer.class),
    ...
    INTEGER_TO_DATE(MycatBuiltInMethodImpl.class, "integerToDate", Integer.class),
    ...
    INTEGER_TO_TIME(MycatBuiltInMethodImpl.class, "integerToDate", Integer.class),
    ...
    INTEGER_TO_TIMESTAMP(MycatBuiltInMethodImpl.class, "integerToTimestamp", Integer.class),
    ...
    INTEGER_TO_BOOLEAN(MycatBuiltInMethodImpl.class, "integerToBoolean", Integer.class),
    ...
    INTEGER_TO_PERIOD(MycatBuiltInMethodImpl.class, "integerToPeriod", Integer.class),
    ...
    INTEGER_TO_DURATION(MycatBuiltInMethodImpl.class, "integerToDuration", Integer.class),
