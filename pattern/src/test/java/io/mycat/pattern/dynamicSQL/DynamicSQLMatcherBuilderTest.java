...
//import io.mycat.pattern.DynamicSQLMatcherBuilder;
//import io.mycat.pattern.Instruction;
//import io.mycat.pattern.InstructionSetImpl;
...
//        DynamicSQLMatcher dynamicSQLMatcher = builder.createMatcher();
//        Instruction match = (Instruction)dynamicSQLMatcher.match("select 1;");
