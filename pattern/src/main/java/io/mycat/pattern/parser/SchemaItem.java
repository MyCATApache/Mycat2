...
public class SchemaItem {
    ...
    private volatile Map<String,FieldItem>        totalFields          = new LinkedHashMap<>();
    ...
    private List<FieldItem> whereFieldItems = new ArrayList<>();
    ...
    public List<FieldItem> getWhereFieldItems() {
        return whereFieldItems;
    }

    public void setWhereFieldItems(List<FieldItem> whereFieldItems) {
        this.whereFieldItems = whereFieldItems;
    }
    ...
    public void setTotalFields(Map<String,FieldItem> totalFields) {
        this.totalFields = totalFields;
    }

    public Map<String,FieldItem> getTotalFields() {
        return totalFields;
    }
    ...
    public List<String> getTableItemAliases(String tableName) {
        ...
        return list.stream()
                .map(SchemaItem.TableItem::getAlias)
    ...
    public static class FieldItem {
        ...
        public void setExistValue(boolean existValue) {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(expr,fieldItem.expr);
        }
