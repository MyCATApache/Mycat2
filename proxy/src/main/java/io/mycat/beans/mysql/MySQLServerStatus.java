...
public final class MySQLServerStatus {
    ...
    public static void main(String[] args) {
        boolean result = MySQLServerStatus.statusCheck(0x0003, MySQLServerStatus.IN_TRANSACTION);
        System.out.println(result);
        boolean resultauto = MySQLServerStatus.statusCheck(0x0003, MySQLServerStatus.AUTO_COMMIT);
        System.out.println(resultauto);
        boolean resulresult = MySQLServerStatus.statusCheck(0x0003, MySQLServerStatus.MORE_RESULTS);
