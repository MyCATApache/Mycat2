 ...
 * 可以根据字段的下标跳过指定列的数据解析
 **/
public class TextResultSetTask implements ResultSetTask {
  int columnCount;
  ColumnDefPacket[] currentColumnDefList;
  ResultSetTransfor collector;
  IntPredicate predicate;

  public TextResultSetTask(ResultSetTransfor collector) {
    this.collector = collector;
    this.predicate = (i) -> true;
  }

  public TextResultSetTask(ResultSetTransfor collector, IntPredicate predicate) {
    this.collector = collector;
