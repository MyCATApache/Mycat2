...
final class JdbcUtils {
    ...
    static class DialectPool {
        ...
        public static final io.mycat.calcite.table.JdbcUtils.DialectPool INSTANCE = new io.mycat.calcite.table.JdbcUtils.DialectPool();
    ...
    static class ObjectArrayRowBuilder implements Function0<Object[]> {
        ...
        public static Function1<ResultSet, Function0<Object[]>> factory(
            ...
            return resultSet -> {
                try {
                    return new io.mycat.calcite.table.JdbcUtils.ObjectArrayRowBuilder(
                            resultSet,
    ...
    static class DataSourcePool {
        public static final io.mycat.calcite.table.JdbcUtils.DataSourcePool INSTANCE = new io.mycat.calcite.table.JdbcUtils.DataSourcePool();

        private final LoadingCache<List<String>, BasicDataSource> cache =
                CacheBuilder.newBuilder().softValues()
                        .build(CacheLoader.from(io.mycat.calcite.table.JdbcUtils.DataSourcePool::dataSource));
