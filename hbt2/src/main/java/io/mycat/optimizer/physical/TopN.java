...
public class TopN extends Sort implements MycatRel {

    public TopN(RelOptCluster cluster, RelTraitSet traits, RelNode child, RelCollation collation, RexNode offset, RexNode fetch) {
