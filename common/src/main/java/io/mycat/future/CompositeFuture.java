 ...
 */
public interface CompositeFuture extends Future<io.vertx.core.CompositeFuture> {
   ...
   */
  static <T1, T2> io.vertx.core.CompositeFuture all(Future<T1> f1, Future<T2> f2) {
   ...
   */
  static <T1, T2, T3> io.vertx.core.CompositeFuture all(Future<T1> f1, Future<T2> f2, Future<T3> f3) {
   ...
   */
  static <T1, T2, T3, T4> io.vertx.core.CompositeFuture all(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4) {
   ...
   */
  static <T1, T2, T3, T4, T5> io.vertx.core.CompositeFuture all(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5) {
   ...
   */
  static <T1, T2, T3, T4, T5, T6> io.vertx.core.CompositeFuture all(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5, Future<T6> f6) {
   ...
   */
  static io.vertx.core.CompositeFuture all(List<Future> futures) {
   ...
   * @return the composite future
   */
  static <T1, T2> io.vertx.core.CompositeFuture any(Future<T1> f1, Future<T2> f2) {
   ...
   */
  static <T1, T2, T3> io.vertx.core.CompositeFuture any(Future<T1> f1, Future<T2> f2, Future<T3> f3) {
   ...
   */
  static <T1, T2, T3, T4> io.vertx.core.CompositeFuture any(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4) {
   ...
   */
  static <T1, T2, T3, T4, T5> io.vertx.core.CompositeFuture any(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5) {
   ...
   */
  static <T1, T2, T3, T4, T5, T6> io.vertx.core.CompositeFuture any(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5, Future<T6> f6) {
   ...
   * When the list is empty, the returned future will be already completed.
   */
  static io.vertx.core.CompositeFuture any(List<Future> futures) {
   ...
   * @return the composite future
   */
  static <T1, T2> io.vertx.core.CompositeFuture join(Future<T1> f1, Future<T2> f2) {
   ...
   */
  static <T1, T2, T3> io.vertx.core.CompositeFuture join(Future<T1> f1, Future<T2> f2, Future<T3> f3) {
   ...
   */
  static <T1, T2, T3, T4> io.vertx.core.CompositeFuture join(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4) {
   ...
   */
  static <T1, T2, T3, T4, T5> io.vertx.core.CompositeFuture join(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5) {
   ...
   */
  static <T1, T2, T3, T4, T5, T6> io.vertx.core.CompositeFuture join(Future<T1> f1, Future<T2> f2, Future<T3> f3, Future<T4> f4, Future<T5> f5, Future<T6> f6) {
   ...
   * When the list is empty, the returned future will be already completed.
   */
  static io.vertx.core.CompositeFuture join(List<Future> futures) {
    return CompositeFutureImpl.join(futures.toArray(new Future[futures.size()]));
  }

  @Override
  io.vertx.core.CompositeFuture setHandler(Handler<AsyncResult<io.vertx.core.CompositeFuture>> handler);
