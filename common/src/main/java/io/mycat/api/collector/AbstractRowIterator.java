...
public abstract class AbstractRowIterator implements RowBaseIterator {
    protected final MycatRowMetaData mycatRowMetaData;
    protected final Iterator<Object[]> iterator;
    private Object[] currentRow;
    private boolean wasNull;

    public AbstractRowIterator(MycatRowMetaData mycatRowMetaData, Iterator<Object[]> iterator) {
