...
import io.mycat.sqlparser.util.simpleParser2.PatternDFGException;
import org.junit.Assert;
import org.junit.Test;

import java.util.Map;

public class SingleRuleGroupPatternTest {
    @Test
    ...
    @Test(expected = PatternDFGException.NameAdjacentException.class)
    ...
    @Test(expected = PatternDFGException.NameLocationAmbiguityException.class)
    ...
    public void testAnnotation19() {
        ...
        int id2 = patternBuilder.addRule("SELECT id FROM travelrecord LIMIT 1");
        GroupPattern groupPattern = patternBuilder.createGroupPattern();
        Matcher matcher = groupPattern.matcher("SELECT id FROM travelrecord LIMIT 1");
        Assert.assertTrue(matcher.acceptAll());
        Assert.assertEquals(0, id);
    ...
    @Test(expected = PatternDFGException.NameAmbiguityException.class)
    ...
    @Test(expected = PatternDFGException.NameSyntaxException.class)
