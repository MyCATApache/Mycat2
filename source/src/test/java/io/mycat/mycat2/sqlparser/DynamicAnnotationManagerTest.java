...
//       Map<Boolean, List<Map<String, String>>> map=
        ...
        DynamicAnnotationKeyRoute keyRoute=new DynamicAnnotationKeyRoute(table);
        ...
        keyRoute.process("schemA",SQLType.INSERT,DynamicAnnotationKeyRoute.stringArray2HashArray(new String[]{"x1"}),context);
    }
    //run
