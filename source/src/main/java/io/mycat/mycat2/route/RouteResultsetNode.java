...
public final class RouteResultsetNode implements Serializable , Comparable<RouteResultsetNode> {
    ...
    // TODO 待支持loadData by zhangsiwei
	...
	public RouteResultsetNode(String name, int sqlType, String srcStatement) {
        ...
        canRunInReadDB =
                (sqlType == BufferSQLContext.SELECT_SQL || sqlType == BufferSQLContext.SHOW_SQL);
        // TODO 待处理balance静态注解 /* mycat:balance type=master*/ by zhangsiwei
	...
	public boolean isUpdateSql() {
		int type=sqlType;
        return BufferSQLContext.INSERT_SQL == type || BufferSQLContext.UPDATE_SQL == type
                || BufferSQLContext.DELETE_SQL == type || BufferSQLContext.CREATE_SQL == type
                || BufferSQLContext.ALTER_SQL == type || BufferSQLContext.DROP_SQL == type
                || BufferSQLContext.TRUNCATE_SQL == type;
	}
