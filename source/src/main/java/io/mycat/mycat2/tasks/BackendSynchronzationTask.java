...
public class BackendSynchronzationTask implements BackendIOTask<MySQLSession> {
    ...
    private AsynTaskCallBack finishCallBack;
    ...
    public BackendSynchronzationTask(MySQLSession session, AsynTaskCallBack callBack) throws IOException {
        this.processCmd = 0;
    ...
    private void syncState(MySQLSession session) throws IOException {
        ...
        switch (processCmd) {
            ...
            case 2:
            case 0:
                CMDS[processCmd].sql = session.getIsolation().getCmd();
    ...
    private void finished(boolean success) throws IOException {
        finishCallBack.finished(session, this, success, this.errPkg);
    }
