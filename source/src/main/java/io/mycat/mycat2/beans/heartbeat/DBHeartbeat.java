...
public abstract class DBHeartbeat {
	...
	public static final int ERROR_CONF = -3;  //主从配置错误
...
//	protected final DataSourceSyncRecorder asynRecorder = new DataSourceSyncRecorder();
	...
	private volatile int slaveBehindMaster;
	private volatile int dbSynStatus = DB_SYN_NORMAL;

	public int getSlaveBehindMaster() {
	...
	public void setSlaveBehindMaster(int slaveBehindMaster) {
