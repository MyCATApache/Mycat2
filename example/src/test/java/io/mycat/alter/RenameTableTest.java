...
public class RenameTableTest implements MycatTest {
    @Test
    public void testNormal() throws Exception {
        try (Connection mycatConnection = getMySQLConnection(DB_MYCAT);
            ...
            execute(mycatConnection, "RENAME  TABLE travelrecord2 to travelrecord3");
            Assert.assertTrue(hasData(mycatConnection, "db1", "travelrecord3"));
        }
    }
