...
//        properties.put("usePipelineAuth", "false");
    ...
    public boolean existTable(Connection connection, String db, String table) throws SQLException {
        return !executeQuery(connection, String.format("SHOW TABLES from %s LIKE '%s';", db, table)).isEmpty();

    }

    public boolean hasData(Connection connection, String db, String table) throws SQLException {
        return !executeQuery(connection, String.format("select * from %s.%s limit 1", db, table)).isEmpty();
    }

    public void deleteData(Connection connection, String db, String table) throws SQLException {
