...
public class RwTest implements MycatTest {
    ...
    public void testSharding() throws Exception {
        try (Connection mycat = getMySQLConnection(8066);
            ...
            execute(mycat,
                    "/*+ mycat:createDatasource{\"name\":\"prototypeDs\",\"url\":\"jdbc:mysql://127.0.0.1:3306\",\"user\":\"root\",\"password\":\"123456\"} */;");
            execute(mycat,
                    "/*+ mycat:createDatasource{\"name\":\"dw0\",\"url\":\"jdbc:mysql://127.0.0.1:3306\",\"user\":\"root\",\"password\":\"123456\"} */;");
            execute(mycat,
                    "/*+ mycat:createDatasource{\"name\":\"dw1\",\"url\":\"jdbc:mysql://127.0.0.1:3307\",\"user\":\"admin\",\"password\":\"123456\"} */;");
            execute(mycat,
                    "/*+ mycat:createCluster{\"name\":\"c0\",\"masters\":[\"dw0\",\"dw1\"],\"replicas\":[]} */;");
            ...
            execute(mycat,
                    "/*+ mycat:setSequence{\"name\":\"mysql_"+tableName+"\",\"clazz\":\"io.mycat.plug.sequence.SequenceMySQLGenerator\"} */;");
