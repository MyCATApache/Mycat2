...
//import io.ordinate.engine.builder.PhysicalSortExpr;
...
//        relBuilder.values(SchemaBuilder.of(ArrowTypes.Int32Type, ArrowTypes.StringType).toArrow(), Arrays.asList(new Object[]{1, "2"}, new Object[]{3, "4"}));
//        relBuilder.filter(relBuilder.makeBooleanLiteral(true));
...
//        {
//            ExecuteCompiler relBuilder = new ExecuteCompiler();
//            relBuilder.values(SchemaBuilder.of(ArrowTypes.Int32Type, ArrowTypes.StringType).toArrow(),
//                    Arrays.asList(
//                            new Object[]{1, "2"},
//                            new Object[]{3, "4"},
//                            new Object[]{null, "4"}
...
//        ExecuteCompiler relBuilder = new ExecuteCompiler();
//        relBuilder.values(SchemaBuilder.of(ArrowTypes.INT32_TYPE, ArrowTypes.STRING_TYPE).toArrow(),
//                Arrays.asList(new Object[]{1, "2"},
//                        new Object[]{3, "4"},
//                        new Object[]{1, "2"}
//                ));
...
//                        new Object[]{1, "2"}
//                ));
//        relBuilder.sort(Arrays.asList(PhysicalSortExpr.of(0, SortOptions.defaultValue()),PhysicalSortExpr.of(1,SortOptions.defaultValue())));
//        PhysicalPlan build = relBuilder.build();
//        OutputLinq4jPhysicalPlan outputLinq4jPhysicalPlan = new OutputLinq4jPhysicalPlan(build);
//        Observable<Object[]> execute = outputLinq4jPhysicalPlan.executeToObject(getRootContext());
//        List<Object[]> objects = execute.toList().blockingGet();
...
//                        new Object[]{3, "22"}
//                ));
//        VariableParameterFunction variableParameterFunction = relBuilder.newCorVariable(InnerType.Int32Type);
//        relBuilder.filter(relBuilder.call("=",relBuilder.column(0),variableParameterFunction));
//        relBuilder.correlate(JoinType.INNER, Collections.singletonMap(0,variableParameterFunction));
//        PhysicalPlan build = relBuilder.build();
//        OutputLinq4jPhysicalPlan outputLinq4jPhysicalPlan = new OutputLinq4jPhysicalPlan(build);
//        Observable<Object[]> execute = outputLinq4jPhysicalPlan.executeToObject(getRootContext());
//        List<Object[]> objects = execute.toList().blockingGet();
...
//        IndexedParameterLinkFunction variableParameterFunction = relBuilder.newIndexVariable(0,InnerType.Int32Type);
