...
public class TopKPlan implements PhysicalPlan {
    private static final Logger LOGGER = LoggerFactory.getLogger(TopKPlan.class);
    private  int offset;
    private int limit;
    private  int fetch;
    ...
    public static TopKPlan create(PhysicalPlan input, List<PhysicalSortProperty> physicalSortProperties,int offset ,int fetch){
        return new TopKPlan(input, physicalSortProperties,offset,fetch);
    }

    public TopKPlan(PhysicalPlan input, List<PhysicalSortProperty> physicalSortProperties, int offset, int fetch) {
        this.input = input;
    ...
    public Observable<VectorSchemaRoot> execute(RootContext rootContext) {
        ...
        }).toObservable().skip(offset).take(fetch);
    }
    ...
    public IntVector lexQuickSort(BufferAllocator allocator, VectorSchemaRoot input, List<SortPlan.SortColumn> physicalSortExprs) {
