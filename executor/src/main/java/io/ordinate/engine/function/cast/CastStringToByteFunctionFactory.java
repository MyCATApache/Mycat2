...
import io.ordinate.engine.function.ByteFunction;
...
public class CastStringToByteFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "cast(string):int8";
    }
    ...
    private static class Func extends ByteFunction implements UnaryFunction {
        ...
        public byte getByte(Record rec) {
            CharSequence str = arg.getString(rec);
