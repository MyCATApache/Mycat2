...
public class TanDoubleFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(List<Function> args, EngineConfiguration configuration) {
        return new TanDoubleFunction(args.get(0));
    }

    private static class TanDoubleFunction extends DoubleFunction implements UnaryFunction {
        private final Function arg;
        boolean isNull;
        public TanDoubleFunction(Function arg) {
            super();
            this.arg = arg;
        }
