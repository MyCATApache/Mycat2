...
public class CastStringToDatetimeFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "cast(string):datetime";
    }
    ...
    public static class Func extends AbstractUnaryDatetimeFunction {
        boolean isNull;
