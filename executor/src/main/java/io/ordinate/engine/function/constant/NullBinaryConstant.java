...
public final class NullBinaryConstant extends BinarySequenceFunction implements ConstantFunction {

    public static final NullBinaryConstant INSTANCE = new NullBinaryConstant();
