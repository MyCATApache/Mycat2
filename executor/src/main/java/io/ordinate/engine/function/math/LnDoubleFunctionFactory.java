...
public class LnDoubleFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(List<Function> args, EngineConfiguration configuration) {
        return new LnDoubleFunction(args.get(0));
    }

    private static class LnDoubleFunction extends DoubleFunction implements UnaryFunction {
        private final Function arg;
        boolean isNull;
        public LnDoubleFunction(Function arg) {
            super();
            this.arg = arg;
        }
