...
public class EqDoubleFunctionFactory implements FunctionFactory {
    ...
    private static class Func extends NegatableBooleanFunction implements BinaryArgFunction {
        private final ScalarFunction doubleFunc1;
        private final ScalarFunction doubleFunc2;

        public Func(ScalarFunction doubleFunc1, ScalarFunction doubleFunc2) {
        ...
        public int getInt(Record rec) {
            return (negated != (doubleFunc1.getDouble(rec) == doubleFunc2.getDouble(rec)))?1:0;
        }
    }
}
