...
public class RoundDoubleFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(List<Function> args, EngineConfiguration configuration) {
        return new RoundDoubleFunction(args.get(0));
    }

    private static class RoundDoubleFunction extends DoubleFunction implements UnaryFunction {
        private final Function arg;
        boolean isNull;
        public RoundDoubleFunction(Function arg) {
            super();
            this.arg = arg;
        }
