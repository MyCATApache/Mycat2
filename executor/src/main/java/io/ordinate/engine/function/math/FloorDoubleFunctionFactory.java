...
public class FloorDoubleFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(List<Function> args, EngineConfiguration configuration) {
        return new FloorDoubleFunction(args.get(0));
    }

    private static class FloorDoubleFunction extends DoubleFunction implements UnaryFunction {
        private final Function arg;
        boolean isNull;
        public FloorDoubleFunction(Function arg) {
            super();
            this.arg = arg;
        }
