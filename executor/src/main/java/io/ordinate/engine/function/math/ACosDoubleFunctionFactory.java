...
public class ACosDoubleFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(List<Function> args, EngineConfiguration configuration) {
        return new ACosDoubleFunction(args.get(0));
    }

    private static class ACosDoubleFunction extends DoubleFunction implements UnaryFunction {
        private final Function arg;
        boolean isNull;

        public ACosDoubleFunction(Function arg) {
            super();
            this.arg = arg;
        }
