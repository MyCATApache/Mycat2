...
public class MinLongAggregateFunction implements LongAccumulator {
    private int columnIndex;
    private int stackIndex;

    public MinLongAggregateFunction(int columnIndex) {
    ...
    public void computeFirst(MapValue reduceContext, Record record) {
        reduceContext.putLong(stackIndex, Long.MAX_VALUE);
