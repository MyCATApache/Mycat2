...
public class CastDoubleToDatetimeFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "cast(double):datetime";
    }
    ...
    private static class Func extends DatetimeFunction implements UnaryFunction {
