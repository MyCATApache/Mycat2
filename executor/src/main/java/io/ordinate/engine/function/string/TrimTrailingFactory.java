...
import io.mycat.calcite.sqlfunction.stringfunction.TrimTrailingFunction;
...
public class TrimTrailingFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "TRIM_TRAILING(string,string)";
    }
    ...
    private static final class Func extends StringFunction {
        ...
        public String getString(Record rec) {
            ...
            String trimLeading = TrimTrailingFunction.trim_trailing(one.getString(rec).toString(), two.getString(rec).toString());
