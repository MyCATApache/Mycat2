...
public class CastDatetimeToBooleanFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "cast(datetime):bool";
    }
    ...
    private static class Func extends BooleanFunction implements UnaryFunction {
        ...
        public int getInt(Record rec) {
            long datetimeMilli = arg.getDatetime(rec);
            isNull= arg.isNull(rec);
            if (isNull)return 0;
            return datetimeMilli>0?1:0;
        }
