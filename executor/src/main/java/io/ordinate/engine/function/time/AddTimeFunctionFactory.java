...
public class AddTimeFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "ADDTIME(datetime,time):datetime";
    }
    ...
    class DateAddFunction extends DatetimeFunction {
        List<Function> args;
        boolean isNull;
