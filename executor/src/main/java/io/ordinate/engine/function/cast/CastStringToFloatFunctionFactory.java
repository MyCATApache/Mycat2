...
import io.ordinate.engine.function.FloatFunction;
...
public class CastStringToFloatFunctionFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "cast(string):float";
    }
    ...
    private static class Func extends FloatFunction implements UnaryFunction {
        ...
        public float getFloat(Record rec) {
            ...
            isNull = value ==null || arg.isNull(rec);
            if (isNull)return 0;
            try {
