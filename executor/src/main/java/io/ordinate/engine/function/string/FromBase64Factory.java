...
import io.mycat.calcite.sqlfunction.stringfunction.FromBase64Function;
...
public class FromBase64Factory implements FunctionFactory {
    @Override
    ...
    private static final class Func extends StringFunction {
        ...
        public CharSequence getString(Record rec) {
            ...
            return new String(FromBase64Function.fromBase64(value.toString()).getBytes());
        }
    }
}
