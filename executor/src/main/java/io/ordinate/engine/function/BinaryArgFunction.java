...
public interface BinaryArgFunction extends ScalarFunction {

    ScalarFunction getLeft();

    ScalarFunction getRight();
    ...
    default boolean isRuntimeConstant() {
        final ScalarFunction l = (ScalarFunction) getLeft();
        final ScalarFunction r = (ScalarFunction) getRight();
