...
@Getter
public class VariableParameterFunction implements ScalarFunction {
    private Function base;

    public VariableParameterFunction(Function base) {
        this.base = base;
    }
    ...
    @Override
    public boolean isNullableConstant() {
        return base.isNullableConstant();
    }

    @Override
    public boolean isNull(Record rec) {
        return base.isNull(rec);
    }
}
