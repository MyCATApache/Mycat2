...
public class TrimLeadingFactory implements FunctionFactory {
    @Override
    public String getSignature() {
        return "TRIM_LEADING(string,string)";
    }
    ...
    private static final class Func extends StringFunction {
        ...
        public String getString(Record rec) {
            ...
            String trimLeading = TrimLeadingFunction.trim_leading(one.getString(rec).toString(), two.getString(rec).toString());
